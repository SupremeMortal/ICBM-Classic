 ...
 */
public interface MissileFlightLogic extends INBTSerializable<CompoundTag> {
    /**
     ...
     */
    default void calculateFlightPath(final Level level, final double startX, final double startY, final double startZ, final MissileTargetingModel targetData) {
