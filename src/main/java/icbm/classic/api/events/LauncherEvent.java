...
public abstract class LauncherEvent extends Event {
    ...
    public static class PreLaunch extends LauncherEvent implements ICancellableEvent {
         ...
         */
        public final MissileTargetingModel target;
        ...
        public PreLaunch(IMissileSource source, IMissileLauncher launcher, IMissileHolder holder, MissileTargetingModel target, boolean simulate) {
