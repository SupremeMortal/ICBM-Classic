...
public final class ICBMClassicAPI {
     ...
     */
    public static IBuilderRegistry<MissileTargetingModel> MISSILE_TARGET_DATA_REGISTRY;
    /**
     * Registry for flight logic save/load in missiles
     */
    public static IBuilderRegistry<MissileFlightLogic> MISSILE_FLIGHT_LOGIC_REGISTRY;
    /**
