...
public interface IMissileLauncher {
     ...
     * <p>
     * {@link #launch(MissileTargetingModel, IMissileCause, boolean)} will often invoke this in addition
     ...
     */
    IActionStatus preCheckLaunch(MissileTargetingModel target, @Nullable IMissileCause cause);
     ...
     */
    @Deprecated
    default IActionStatus launch(MissileTargetingModel target, @Nullable IMissileCause cause, boolean simulate) {
