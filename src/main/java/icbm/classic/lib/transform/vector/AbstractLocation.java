...
public abstract class AbstractLocation<R extends AbstractLocation> extends AbstractPos<R> implements ILocation {
    ...
    public AbstractLocation(CompoundTag nbt) {
        this(DimensionManager.getLevel(nbt.getInt(NBTConstants.DIMENSION)), nbt.getDouble(NBTConstants.X), nbt.getDouble(NBTConstants.Y), nbt.getDouble(NBTConstants.Z));
    }
