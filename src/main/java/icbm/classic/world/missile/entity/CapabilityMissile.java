...
public class CapabilityMissile implements IMissile, INBTSerializable<CompoundTag> {
    ...
    private MissileTargetingModel targetData;

    private IMissileSource firingSource;

    private MissileFlightLogic flightLogic;
    ...
    @Override
    public void setTargetData(MissileTargetingModel data) {
        this.targetData = data;
    }

    @Override
    public MissileTargetingModel getTargetData() {
        return this.targetData;
    }

    @Override
    public void setFlightLogic(MissileFlightLogic logic) {
        this.missile.syncClient = true;
        this.flightLogic = logic;
    }

    @Override
    public void switchFlightLogic(MissileFlightLogic logic) {
    ...
    @Override
    public MissileFlightLogic getFlightLogic() {
    ...
    private static final NbtSaveHandler<CapabilityMissile> SAVE_LOGIC = new NbtSaveHandler<CapabilityMissile>()
        ...
        /* */.node(new NbtSaveNode<CapabilityMissile, CompoundTag>("target",
            ...
            (cap, data) -> {
                ...
                if (cap.getTargetData() == null) {
                    ...
                    final MissileTargetingModel target = ICBMClassicAPI.MISSILE_TARGET_DATA_REGISTRY.build(saveId);
                    if (target != null) {
        ...
        /* */.node(new NbtSaveNode<CapabilityMissile, CompoundTag>("flight",
            (missile) -> { //TODO convert to class to make cleaner and provide better testing surface
                ...
                final MissileFlightLogic logic = missile.getFlightLogic();
                if (logic != null) {
            ...
            (missile, data) -> {
                final ResourceLocation saveId = new ResourceLocation(data.getString("id"));
                final MissileFlightLogic logic = ICBMClassicAPI.MISSILE_FLIGHT_LOGIC_REGISTRY.build(saveId);
                if (logic != null) {
                    if (data.contains("data")) {
