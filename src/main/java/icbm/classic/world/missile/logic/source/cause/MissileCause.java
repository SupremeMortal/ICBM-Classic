...
public abstract class MissileCause implements IMissileCause {
    ...
    private final MissileCauseType<?> type;
    private IMissileCause parent;

    public MissileCause(MissileCauseType<?> type) {
        this.type = type;
    }

    public IMissileCause setPreviousCause(MissileCauseType<?> type, IMissileCause parent) {
        this.parent = parent;
        return this;
    }

    public MissileCauseType<?> getType() {
        return type;
    }
