 ...
 */
@Deprecated
public class BallisticFlightLogicOld implements MissileFlightLogic //TODO remove after we update to 1.12 or confident no more save data is using it
{
    ...
    @Override
    public void calculateFlightPath(final Level level, double startX, double startY, double startZ, final MissileTargetingModel targetData) {
