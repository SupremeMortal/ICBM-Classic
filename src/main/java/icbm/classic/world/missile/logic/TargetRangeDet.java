...
public class TargetRangeDet {
    ...
    public void update() {
        if (missile.getMissileCapability().getTargetData() instanceof BallisticTargetingModel) {
            final double offset = ((BallisticTargetingModel) missile.getMissileCapability().getTargetData()).getImpactHeightOffset();
            if (offset > 0) {
