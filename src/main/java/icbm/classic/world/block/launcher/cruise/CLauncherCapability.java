...
public class CLauncherCapability extends LauncherBaseCapability {
    ...
    @Override
    public IActionStatus preCheckLaunch(MissileTargetingModel target, @Nullable IMissileCause cause) {
        return getStatus();
    }
    ...
    public IActionStatus launch(ILauncherSolution solution, @Nullable IMissileCause cause, boolean simulate) {
        ...
        final MissileTargetingModel target = solution.getTarget(this);
