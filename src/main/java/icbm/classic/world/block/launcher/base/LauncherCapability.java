...
public class LauncherCapability extends LauncherBaseCapability {
    ...
    @Override
    public IActionStatus preCheckLaunch(MissileTargetingModel targetData, @Nullable IMissileCause cause) {
    ...
    public IActionStatus launch(ILauncherSolution solution, @Nullable IMissileCause cause, boolean simulate) {
        ...
        final MissileTargetingModel targetData = solution.getTarget(this);
        ...
        if (stack.hasCapability(ICBMClassicAPI.MISSILE_STACK_CAPABILITY, null)) {
            ...
            if (missileStack != null) {
                ...
                if (host.getFiringPackage() == null) {
                    ...
                    if (targetData instanceof IMissileTargetingDelayed) {
                        delay += ((IMissileTargetingDelayed) targetData).getFiringDelay();
                    }
    ...
    private IActionStatus fireMissile(IMissile missile, MissileSource source, Vec3 target) {
        ...
        missile.setTargetData(new BallisticTargetingModel(target, 1));
    ...
    public MissileFlightLogic buildFLightPath() {
        ...
        if (host.getLaunchDirection() != Direction.UP) {
            ...
            MissileFlightLogic arcFlight = new ArcFlightLogic();
