...
public class FiringPackage implements INBTSerializable<CompoundTag>, ITick {
    ...
    public FiringPackage(MissileTargetingModel targetData, IMissileCause cause, int countDown) {
        this.targetData = targetData;
        this.cause = cause;
        this.countDown = countDown;
    }

    public FiringPackage(MissileTargetingModel targetData, IMissileCause cause) {
        this.targetData = targetData;
        this.cause = cause;
    }
    ...
    public void launch(IMissileLauncher missileLauncher) {
        ...
        if (!hasFired) {
            ...
            if (targetData instanceof IMissileTargetingDelayed) {
                targetData = ((IMissileTargetingDelayed) targetData).cloneWithoutDelay();
            }
